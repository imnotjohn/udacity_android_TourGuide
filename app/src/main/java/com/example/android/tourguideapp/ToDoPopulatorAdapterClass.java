 ...
 */
public class ToDoPopulatorAdapterClass extends ArrayAdapter<ToDoPopulator> {

    public ToDoPopulatorAdapterClass(Activity context, int position, ArrayList<ToDoPopulator> toDoPopulatorArrayList) {
